...
latex_documents = [
  ('index', 'function-pipe.tex', 'function-pipe Documentation',
   'Christopher Ariza', 'manual'),
]
...
man_pages = [
    ('index', 'function-pipe', 'function-pipe Documentation',
     ['Christopher Ariza'], 1)
]
...
texinfo_documents = [
  ('index', 'function-pipe', 'function-pipe Documentation',
   'Christopher Ariza', 'function-pipe', 'One line description of project.',
   'Miscellaneous'),
]
